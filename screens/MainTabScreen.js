  ...
  switch (routeName) {
    case 'Plan List': 
      return [<Icon.Button key={0} name="ios-search" size={20} iconStyle={{marginRight: 2.5,marginLeft: 2.5}} backgroundColor= {colors.primary} underlayColor= 'grey' onPress={() => [setPlan(Plan = !Plan)]}></Icon.Button>,
              ...
              <Icon5.Button key={3} name="filter" size={21} iconStyle={{marginRight: 2.5,marginLeft: 2.5}} backgroundColor= {colors.primary} underlayColor= 'grey' onPress={() => navigation.navigate('SearchModal')}></Icon5.Button>];//Plansearch() //navigation.setParams({plansearch: !route.params.plansearch})
    case 'Plan Details':
